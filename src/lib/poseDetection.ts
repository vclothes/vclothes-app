...
// MediaPipe's 33-point body landmark indices. Elbows/knees are only used to
// draw a natural-looking skeleton overlay; the pose scoring below doesn't
// need them.
...
// Raw keypoints (score = MediaPipe's per-landmark "visibility", not yet
// filtered by MIN_SCORE) — the caller decides what to do with low-confidence
// ones (e.g. still draw them, dimmer).
